...
- (void)initializer
{
    ...
    [self.cellScrollView addSubview:self.gameNamesLabel];
    ...
    [self.cellScrollView addSubview:self.startsWhenLabel];
    ...
    [self.cellScrollView addSubview:self.distanceAddressLabel];
    ...
    [self.cellScrollView addSubview:self.creatorImageView];
    ...
    [self.cellScrollView addSubview:self.responseStatusVerticalBar];
    
    [NSLayoutConstraint rightOfChild:self.gameNamesLabel toLeftOfSibling:self.responseStatusVerticalBar withFixedMargin:-labelToResponseBarBuffer inParent:self.cellScrollView];
    [NSLayoutConstraint leftOfChild:self.gameNamesLabel toRightOfSibling:self.creatorImageView withFixedMargin:imageToLabelBuffer inParent:self.cellScrollView];
//    [NSLayoutConstraint topOfChild:self.gameNamesLabel toTopOfParent:self.cellScrollView withFixedMargin:10];
    [NSLayoutConstraint bottomOfChild:self.gameNamesLabel toTopOfSibling:self.startsWhenLabel withFixedMargin:-labelSeparationBuffer inParent:self.cellScrollView];
    
    [NSLayoutConstraint centerYOfChild:self.startsWhenLabel toCenterYOfParent:self.cellScrollView];
    [NSLayoutConstraint rightOfChild:self.startsWhenLabel toLeftOfSibling:self.responseStatusVerticalBar withFixedMargin:-labelToResponseBarBuffer inParent:self.cellScrollView];
    [NSLayoutConstraint leftOfChild:self.startsWhenLabel toRightOfSibling:self.creatorImageView withFixedMargin:imageToLabelBuffer inParent:self.cellScrollView];
    
    [NSLayoutConstraint rightOfChild:self.distanceAddressLabel toLeftOfSibling:self.responseStatusVerticalBar withFixedMargin:-labelToResponseBarBuffer inParent:self.cellScrollView];
    [NSLayoutConstraint leftOfChild:self.distanceAddressLabel toRightOfSibling:self.creatorImageView withFixedMargin:imageToLabelBuffer inParent:self.cellScrollView];
//    [NSLayoutConstraint bottomOfChild:self.distanceAddressLabel toBottomOfParent:self.cellScrollView withFixedMargin:0];
    [NSLayoutConstraint topOfChild:self.distanceAddressLabel toBottomOfSibling:self.startsWhenLabel withFixedMargin:labelSeparationBuffer inParent:self.cellScrollView];
    ...
    [NSLayoutConstraint centerYOfChild:self.creatorImageView toCenterYOfParent:self.cellScrollView];
    [NSLayoutConstraint leftOfChild:self.creatorImageView toLeftOfParent:self.cellScrollView withFixedMargin:imageToEdgeBuffer];
    
    [NSLayoutConstraint topOfChild:self.responseStatusVerticalBar toTopOfParent:self];
    [NSLayoutConstraint bottomOfChild:self.responseStatusVerticalBar toBottomOfParent:self];
    [NSLayoutConstraint rightOfChild:self.responseStatusVerticalBar toRightOfParent:self.cellScrollView withFixedMargin:0];
...
- (void)layoutSubviews
{
    ...
    NSLog(@"cell Frame :: %@",NSStringFromCGRect(self.cellScrollView.frame));
    NSLog(@"view Frame :: %@",NSStringFromCGRect(_contentCellView.frame));
...
//        self.responseStatusVerticalBar.alpha = self.cellState == kCellStateCenter;
    }];
}
